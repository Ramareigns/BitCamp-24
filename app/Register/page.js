...
export default function Register({  }) {
  ...
  return (
    ...
    <div id="container" class="bg-blue-500 w-full h-500 rounded-lg shadow-2xl flex flex-col lg:flex-row items-center justify-center lg:justify-between">
        ...
        <div id="pictureSide" class="relative bg-white rounded-l-lg hidden lg:block w-full h-full">
            <div class="w-full h-full rounded-l-lg overflow-hidden opacity-30">
                <img src="/House2.jpg" alt="Image" class="w-full h-full object-cover" />
            </div>
            <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center">
                <h1 class="text-black font-bold text-4xl mb-6">Welcome</h1>
                <p class="text-black mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget urna justo.</p>
                <p class="text-black mb-6">Have a Account Already?</p>
        ...
        <div id="loginSide" class="w-full lg:w-1/2 flex flex-col p-10 items-center justify-center">
            <h1 class="text-3xl font-bold text-white mb-4 text-center">Register</h1>
            <form class="flex flex-col items-center">
                ...
                <input type="password" placeholder="Full Name" class="border-b-2 border-white focus:outline-none focus:border-blue-200 mb-8 text-white bg-white placeholder-gray-300 w-full lg:w-auto px-2 py-1 rounded-md" />
                ...
                <button id="signUpButton" class="bg-white text-blue-500 py-2 px-4 rounded-lg hover:bg-blue-100 transition duration-300" >Sign Up</button>
            </form>
        </div>
    </div>
</main>
